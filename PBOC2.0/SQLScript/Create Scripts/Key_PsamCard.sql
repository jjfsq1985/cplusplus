...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'TAC密钥' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Key_PsamCard', @level2type=N'COLUMN',@level2name=N'TacKey'
GO
...
--								'11111111111111111111111111111111',
--						--		'000102030405060708090A0B0C0D0E0F', --新增的TAC密钥
--								'000102030405060708090A0B0C0D0E0F',
--								N'测试密钥');
--GO
