...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'»Ò¿¨½ð¶î' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Data_LockGrayRecord', @level2type=N'COLUMN',@level2name=N'LockMoney'
GO
