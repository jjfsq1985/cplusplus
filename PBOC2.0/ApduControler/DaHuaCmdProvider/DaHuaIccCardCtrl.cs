...
namespace DaHuaApduCtrl
{
    public class DaHuaIccCardCtrl : DaHuaCardCtrlBase, ISamCardControl
    {
        ...
        //private static readonly byte[] m_ADF01 = new byte[] { 0x53, 0x49, 0x4E, 0x4F, 0x50, 0x45, 0x43, 0x31 };//SINOPEC1
        //private static readonly byte[] m_ADF02 = new byte[] { 0x53, 0x49, 0x4E, 0x4F, 0x50, 0x45, 0x43, 0x32 };//SINOPEC2
        private static readonly byte[] m_ADF01 = new byte[] { 0x45, 0x4E, 0x45, 0x52, 0x47, 0x59, 0x2E, 0x30, 0x31 };//ENERGY.01
        private static readonly byte[] m_ADF02 = new byte[] { 0x45, 0x4E, 0x45, 0x52, 0x47, 0x59, 0x2E, 0x30, 0x32 };//ENERGY.02
        //应用主控密钥
        private byte[] m_MAMK = new byte[16];
        //应用维护密钥
        private byte[] m_MAMTK = new byte[16];
        //消费主密钥1
        private byte[] m_MPK1 = new byte[16];
        //消费主密钥2
        private byte[] m_MPK2 = new byte[16];
        //消费主密钥3
        private byte[] m_MPK3 = new byte[16];
        //灰锁主密钥1
        private byte[] m_MDK1 = new byte[16];
        //灰锁主密钥2
        private byte[] m_MDK2 = new byte[16];
        //灰锁主密钥3
        private byte[] m_MDK3 = new byte[16];
        //DTK 
        private byte[] m_DTK = new byte[16];
        //密钥（MAC加密等）
        private byte[] m_MADK = new byte[16];
