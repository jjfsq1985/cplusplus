...
CREATE PROCEDURE PROC_GetCpuKey(
 ...
 AS    
	...
	select * from Key_CpuCard inner join Key_CARD_ADF on Key_CpuCard.KeyId = Key_CARD_ADF.RelatedKeyId where Key_CpuCard.KeyId=@CpuKeyId and Key_CARD_ADF.ApplicationIndex = @ApplicationIndex;
	if(@@ERROR <> 0)
		begin
