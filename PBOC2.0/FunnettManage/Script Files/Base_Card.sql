...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'账户余额（单位母卡余额）' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Base_Card', @level2type=N'COLUMN',@level2name=N'AccountBalance'
GO
